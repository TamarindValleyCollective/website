...
export default {
  ...
  forms: {
    ...
    requiredNote: '(ಐಚ್ಛಿಕ) ಎಂದು ಗುರುತಿಸದ ಹೊರತು ಎಲ್ಲಾ ಕ್ಷೇತ್ರಗಳು ಅಗತ್ಯವಿದೆ.',
  },
  translationNotice: {
  ...
  jsonLd: {
    orgDescription:
      'ಇದು ಕೇವಲ ಒಂದು ಫಾರ್ಮ್ ಅಲ್ಲ — ಒಂದು ಪುನರುಜ್ಜೀವನಗೊಳ್ಳುತ್ತಿರುವ ಪರಿಸರ ವ್ಯವಸ್ಥೆ: ಕನಕಪುರದ ಬಳಿಯ ಮೇಲಗಿರಿ ಬೆಟ್ಟಗಳ {acres} ಎಕರೆ ಭೂಮಿಯನ್ನು 2017ರಿಂದ {families} ಕುಟುಂಬಗಳು ಪರ್ಮಾಕಲ್ಚರ್ ಮತ್ತು ಮರುಅರಣ್ಯೀಕರಣದ ಮೂಲಕ ಪುನರುಜ್ಜೀವನಗೊಳಿಸುತ್ತಿವೆ.',
  },
  cookie: {
    text: 'ಈ ಸೈಟ್ ಅನ್ನು ಸಂದರ್ಶಕರು ಹೇಗೆ ಬಳಸುತ್ತಾರೆ ಎಂಬುದನ್ನು ಅರ್ಥಮಾಡಿಕೊಳ್ಳಲು ನಾವು Google Analytics ಮತ್ತು Microsoft Clarity ಬಳಸಲು ಬಯಸುತ್ತೇವೆ. ನೀವು ಒಪ್ಪಿಗೆ ನೀಡುವವರೆಗೆ ನಾವು ಅನಾಲಿಟಿಕ್ಸ್ ಕುಕೀಗಳನ್ನು ಹೊಂದಿಸುವುದಿಲ್ಲ — ಇದರ ಅರ್ಥವೇನೆಂದು ತಿಳಿಯಲು ನಮ್ಮ <a href="/privacy/">ಗೌಪ್ಯತೆ ಮತ್ತು ಕುಕೀಸ್</a> ಪುಟವನ್ನು ನೋಡಿ.',
    reject: 'ತಿರಸ್ಕರಿಸಿ',
    accept: 'ಒಪ್ಪಿಗೆ',
  },
  weather: {
  ...
  search: {
    ...
    askAi: '✨ AI ಗೆ ಕೇಳಿ',
    aiThinking: 'ಯೋಚಿಸುತ್ತಿದೆ…',
    aiError: 'ಈಗ AI ಉತ್ತರ ಸಿಗಲಿಲ್ಲ. ದಯವಿಟ್ಟು ಸ್ವಲ್ಪ ಸಮಯದ ನಂತರ ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ.',
    aiDisclaimer: 'AI ರಚಿಸಿದ ಉತ್ತರ — ಲಿಂಕ್ ಮಾಡಿದ ಪುಟಗಳಲ್ಲಿ ಖಚಿತಪಡಿಸಿಕೊಳ್ಳಿ.',
  },
  chat: {
  ...
  joinTeaser: {
    heading: 'ಸದಸ್ಯರಾಗಲು ಆಸಕ್ತಿ ಇದೆಯೇ?',
    text: 'ಸದಸ್ಯತ್ವ ನಿಜವಾಗಿಯೂ ಮುಕ್ತವಾಗಿಲ್ಲ — {families} ಕುಟುಂಬಗಳು ಈ ಸಮುದಾಯ ಬೆಳೆಯಬಹುದಾದ ಗರಿಷ್ಠ ಗಾತ್ರಕ್ಕೆ ಹತ್ತಿರವಾಗಿದೆ. ಒಂದು ಸ್ಥಾನ ತೆರೆದಾಗ, ಅದು ಯಾವುದೇ ಅರ್ಜಿ ಪ್ರಕ್ರಿಯೆಯ ಮೂಲಕ ಅಲ್ಲ, ಬದಲಾಗಿ ಸದಸ್ಯರ ನಡುವೆ ಖಾಸಗಿಯಾಗಿ ಹಸ್ತಾಂತರಗೊಳ್ಳುತ್ತದೆ. ಅದು ನಿಖರವಾಗಿ ಹೇಗೆ ಕಾರ್ಯನಿರ್ವಹಿಸುತ್ತದೆ ಎಂಬುದು ಇಲ್ಲಿದೆ.',
    cta: 'ಅದು ಹೇಗೆ ಕಾರ್ಯನಿರ್ವಹಿಸುತ್ತದೆ ಎಂಬುದನ್ನು ಓದಿ →',
  },
} as const;
