...
export const members: Member[] = [
  ...
  { name: 'Ram & Krishna', summary: 'Ram previously worked at Philips Software/T P Vision; Krishna leads Technology Portfolio for Azim Premji University.', bio: 'Ram worked in Philips Software Centre/T P Vision, and right now is exploring other interests in life, including options for a sustainable living. Krishna is with Azim Premji Foundation, working as Technology Portfolio Lead for the University (APU). She has many other interests as well, and also publishes the podcast New Indian Woman.', photo: '/images/members/ram-and-krishna.jpg', family: 'Ram and Krishna have two children: Nithya, currently in the Civil Service (IRS), and Varun, in his final year of the BS-MS course at IISER TVM with Physics as major and Bio as minor.', familyNames: ['Nithya', 'Varun'], whyTVC: 'A fascination towards mindful and sustainable living, being part of a community with like minded individuals exploring together how to live with nature, and trying to grow/produce something rather than just being a consumer are some of the things that drew us towards TVC.' },
