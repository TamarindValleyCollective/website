...
export const members: Member[] = [
  { name: 'Abhinav & Divya', summary: 'Divya is a home baker and chef; Abhinav is a product manager at VMware by Broadcom.', bio: 'Divya is a home baker and chef, focusing on healthy food. Abhinav is a product manager with VMware by Broadcom, working on software networking products.', photo: '/images/members/abhinav-and-divya.jpg', family: 'Divya and Abhinav live in south Bangalore and are married with one son, Pranav (15).', familyNames: ['Pranav'], whyTVC: 'Aligned with the concept and philosophy of TVC, and staying for the lovely people and community.', social: ['https://linkedin.com/in/abhinavmodi', 'https://www.instagram.com/divya.pics'] },
  ...
  { name: 'Amit & Jayashree', summary: 'Jayashree is a Curriculum Developer; Amit is an Engineering Manager.', bio: 'Jayashree is a Curriculum Developer, designing tech courses and certifications. Amit is an Engineering Manager.', photo: '/images/members/amit-and-jayashree.jpg', family: 'Their daughter Gargi is pursuing undergrad at UT Austin.', familyNames: ['Gargi'], whyTVC: 'Wanted a place to grow our own food and live close to nature.' },
  ...
  { name: 'Ashirwad & Harshada', summary: 'Ashirwad conducts drum circles and meditation sessions; Harshada is a non-practicing Ayurvedic doctor and diet-planning expert.', bio: "After hanging up his boots in the IT industry, Ashirwad conducts drum circles combined with intense meditations, and continues to be a student of tabla and guitar. He is exploring endeavours in the education space, connecting those seeking knowledge with those who have already found it. Harshada is a non-practicing Ayurvedic doctor who loves learning the languages of humans and birds. She designs Ashirwad's drum-jamming sessions, which he then executes, and is an expert in diet planning, thriving even in highly constrained cooking environments.", photo: '/images/members/ashirwad-and-harshadha.jpg', family: "Ashirwad and Harshada are married with two sons, Chirantan and Arnav. Chirantan (25) is pursuing a Master's in AI of Autonomous Systems in Ingolstadt, Germany, and Arnav (22), an electrical engineer from Monash University, designs earthing systems at ZSE in Melbourne, Australia. Ashirwad is a musician and Harshada an enthusiastic linguist and risk-taking cook; they both love birding and exploring places at a slow pace.", familyNames: ['Chirantan', 'Arnav'], whyTVC: 'We are at TVC to be in the fresh air, to be with the birds, and to work with the soil.', social: ['https://www.linkedin.com/in/ashirwada/'] },
  ...
  { name: 'Rajavel & Vidhya', summary: 'Vidhya is an early-childhood educator and yoga practitioner; Rajavel is a UX design academician.', bio: 'Vidhya is an early childhood educator, now focussing on yoga and physical wellness. She is a dancer and a gardener among many other things. Rajavel is a UX design academician and practitioner who likes to insist UX is not just digital. He also likes to weave his average endurance-running hobby into any conversation.', photo: '/images/members/rajavel-and-vidhya.jpg', family: 'Vidhya and Rajavel are married with one son, Harieshwar (24), a counselling psychologist, and their adopted pet Jarvis (9), who wags her tail more gently toward humans than toward her own species.', familyNames: ['Harieshwar', 'Jarvis'], whyTVC: 'We wanted to be in and part of a journey that will help us to be close to the soil and learn to be by ourselves.' },
  ...
  { name: 'Kiran & Zainab', summary: 'Kiran is a tool maker and founder of Hasgeek; Zainab builds communities at Hasgeek & TVC.', bio: "Kiran likes to think of himself as a tool maker. In the course of his life's journey, Kiran founded Hasgeek, steered the volunteer-led Save The Internet (STI) movement on Net Neutrality, registered his dissent against Aadhaar, and continues his experiments with hardware projects. Zainab is learning what it takes to build & sustain communities at Hasgeek & TVC.", photo: '/images/members/kiran-and-zainab.jpg', family: 'Kiran and Zainab are married in life and sometimes at work, and in jointly raising their venture Amal Zaiki. Amal enjoys practising head stands and building models with clay. Kiran builds lots of boxes including video cubes and a CNC mill. Zainab is currently interested in learning how to grow food, and how children learn.', familyNames: ['Amal'], whyTVC: 'Because communities will be the anchors of our lives increasingly, in the times to come.', social: ['https://x.com/jackerhack', 'https://factordaily.com/meet-indiasgeekiest-couplekiran-jonnalagadda-and-zainab-bawa/'] },
  ...
  { name: 'Sameer & Shubha', summary: 'Shubha works on water sustainability at Biome; Sameer is an Ecosystem Fellow.', bio: 'Shubha is a water sustainability expert and advisor to Biome. Sameer is an Ecosystem Fellow trying to bring focus to more urgent climate action. Both have moved to their farm in Coorg and are learning to live off the land to the extent possible.', photo: '/images/members/sameer-and-shubha.jpg', family: 'Akshat is working in semiconductors and plays Ultimate Frisbee. Alankrita is finishing her B.Sc. Bio (Hons) programme.', familyNames: ['Akshat', 'Alankrita'], whyTVC: 'It was important to find a tribe that believes in a different, more sustainable way of life. The TVC community is exactly that!' },
