...
site. The one that previously existed, on the Foraging Day event page
(`https://rzp.io/rzp/Pry5rI8r`, fixed `66614ab`, 2026-07-17), stopped being reachable when that
event was set `draft: true` after being postponed indefinitely (`a424212`, 2026-07-25) — draft
events are filtered out of both `/events` and their own detail route.
